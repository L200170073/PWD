...
<body>
    <br>
    <h1><b>Sugeng Rawuh</b></h1>
    <center><h2>WKWKWKWKWKW.COM</h2></center>
    <div class="kotak_login">
        <p class="tulisan_login">Nyuwun Sewu Di isi Rumiyin</p>
        <form action="tugas.php" method="POST">
            ...
            <input type="submit" value="Mlebu" name="submit" id="submit" class="tombol_login">
            <br><br>
        </form>
    </div>
</body>
